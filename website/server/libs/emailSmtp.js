...
let templates = {
	...
	'party-invite-rescinded': {
		...
		text: (variables) => `You are no longer invited to join the party ${variables['PARTY_NAME']}.`,
		button_text: "Visit Habitica",
		button_link: (variables) => variables['BASE_URL'],
		text_before: (variables) => `You are no longer invited to join the party ${variables['PARTY_NAME']}.`
	},
	'kicked-from-party': {

...
- cannot send emails, because a web service is used for that by Habitica (an extension with a mailer daemon like in the (outdated) [Shabitica Repository](https://github.com/headcounter/shabitica/tree/master/mailer) could be an option)
...
Contributions to fix those are very welcome. 😊
